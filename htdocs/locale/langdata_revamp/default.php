...
$LANG_ARRAY = array ( 
		...
		"PATIENTS" => "Patients", 
		"PATIENT_NAME" => "Patient Name", 
		"PATIENT_ID" => "Registration Number", 
		"ADDL_ID" => "Patient No.", 
		"GENDER" => "Sex", 
		"MALE" => "Male", 
		"FEMALE" => "Female", 
		"PATIENT_DAILYNUM" => "Specimen Number", 
		"AGE" => "Age", 
		"OR" => "Or", 
		"DOB" => "Date of Birth", 
		"YEARS" => "Years", 
		...
		"SWITCH_TOTECH" => "Work as Technologist", 
		...
		"TIPS_ACC_CONFIRMDEACTIVATE" => "Are you sure you want to deactivate this account?",
	...
	"footer" => array ( 
		"TITLE" => "", 
		"FOOTER_MSG" => "", //"A joint initiative of C4G @ Georgia Tech, the CDC, @iLabAfrica, APHL and participating countries", 
	...
	"find_patient" => array ( 
		...
		"MENU_LAB_REQUESTS"=>"Lab Requests",
		"MENU_PATIENT_LOOKUP"=>"Patient look-up",
	...
	"new_patient" => array ( 
		...
		"TIPS_DOB_AGE" => "* Enter either <i>Age</i> or <i>Date of Birth</i>"
	) , 
	"new_specimen" => array ( 
	...
	"results_entry" => array ( 
		...
		"MENU_PENDING_TESTS"=>"Pending Tests",
		"MENU_PENDING_RESULTS"=>"Pending Results",
		...
		"MENU_QUALITY_CONTROLS" => "Quality Control Tests"
	) , 
	"search" => array ( 
		"TITLE" => "Search",
	...
	"lab_config_home" => array ( 
		...
		"TIPS_REGISTRATIONFIELDS_3" => "-",		"MENU_TAT" => "Target TAT", 
		...
		"ASSIGN_TO" => "Assign To", 
		"TIPS_LABDELETE" => "Are you sure you want to delete this lab configuration? All data and Technologist accounts will be deleted permanently.", 
	...
	"lab_admins" => array ( 
		...
		"TIPS_MANAGELAB" => "To edit Technologist accounts, use Manage option in Lab Configurations page.", 
