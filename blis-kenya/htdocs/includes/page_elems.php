		...
		<table class='table table-hover table-bordered' id='specimen_tests_table'>
			<thead>
				...
				<th style="font-size:12px"><?php echo "Specimen Id"; ?></th>
					...
					<th style="font-size:12px" colspan="1"><?php echo LangUtil::$generalTerms['VERIFIED_BY']; ?></th>
		...
		<form name='<?php echo $form_name; ?>' id='<?php echo $form_id; ?>' action='ajax/specimen_add.php?session_num=<?php echo $session_num ?>' method='post'>
			...
			?>>
				...
				<td>
					...
					<input class="m-wrap m-ctrl-medium" size="16" id="<?php echo $date_id; ?>" name="spec_date" type="text" value="<?php echo date("Y-m-d"); ?>" readonly>
			...
			<tr>
				...
				<td>
                    ...
                    <input class="m-wrap m-ctrl-small timepicker-24" id="<?php echo $time_id ?>" name="spec_time" type="text" value="<?php echo date("H:i"); ?>" readonly>
